...
const IndexSelector = ({ 
  ...
  const variants = {
    default: {
      ...
      retryButton: 'px-3 py-2 text-sm bg-red-100 text-red-700 rounded hover:bg-red-200 flex items-center'
    },
    compact: {
      container: 'relative',
      ...
      retryButton: 'px-2 py-1 text-xs bg-red-100 text-red-700 rounded hover:bg-red-200 flex items-center'
    },
    detailed: {
