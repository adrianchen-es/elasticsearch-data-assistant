    ...
    async def start_scheduler_async(self):
        ...
        with tracer.start_as_current_span(
            ...
            try:
                ...
                scheduler_span.set_status(Status(StatusCode.OK, "Scheduler started successfully"))
    ...
    async def _safe_refresh_all(self):
        ...
        with tracer.start_as_current_span(
            ...
            try:
                ...
                await self.refresh_all()
                refresh_span.set_status(Status(StatusCode.OK, "Scheduled refresh completed"))
    ...
    async def refresh_all(self):
        ...
        with tracer.start_as_current_span(
            ...
            try:
                ...
                refresh_span.set_status(Status(StatusCode.OK, f"Refresh completed: {successful_refreshes}/{len(indices)} successful"))
